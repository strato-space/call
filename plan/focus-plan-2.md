...
- [ ] **Выходы:** Сохранённый или обновлённый агент в каталоге `prompt/agents/`
...
- [ ] **Что:** связать стадии презентера и сохранить промежуточные/финальные артефакты через FS‑MCP
