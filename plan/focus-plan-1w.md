...
- **Формат промптов** — схема Strato (принята [ ] указать ссылку на пример), «неразрушительная» трансформация через StratoFormatter (сохраняет весь текст и атрибутику).   
...
### E2. @StratoFormatter (неразрушительное форматирование)
...
- **Юра** – Доделать StratoFormatter: режим «неразрушительный», пакетный прогон каталога `prompt/agents/` (E2). [Aug 17] [P1]   
