        ...
        lambda **kw: [
            {
                "project": "FanFab",
                "agent": "Stratoslav",
                "prompt": "StratoSammary",
                "path": str(p1),
                "state": "ready",
                "target": "StratoSammary",
                "engine": "",
                "orchestration": "",
            },
            {
                "project": "FanFab",
                "agent": "Stratoslav",
                "prompt": "130-QAcriteriaDefinition",
                "path": str(p2),
                "state": "ready",
                "target": "130-QAcriteriaDefinition",
                "engine": "",
                "orchestration": "",
            },
        ],
...
def test_prompts_filtering_by_state_and_agent(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        ...
        lambda **kw: (
            rows
            if (
                (kw.get("state") in (None, "ready"))
                and (kw.get("agent") in (None, "Stratoslav"))
            )
            else []
        ),
        raising=True,
            ...
            [
                {
                    ...
                    "path": str(f),
                    "state": "ready",
                    "target": "33-Questioning",
                    "engine": "",
                    "orchestration": "",
                }
            ]
            if ((kw.get("prompt") in ("33-Questioning", None)))
            else []
        ),
        raising=True,
    )
