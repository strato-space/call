"""SQLite-backed repository index query helpers.

Filesystem scanning lives in :mod:`call.lib.repo_fs`. This module only exposes
read/query utilities backed by ``repo.db``.
"""
...
from call.lib.discovery import load_projects_index
