...
- **MCP Hook:** Improved debug print formatting for MCP tool results. JSON strings in `content[].text` fields are now parsed and displayed as structured YAML instead of escaped JSON, making tool output much cleaner and more readable. (`app/call.py`)
